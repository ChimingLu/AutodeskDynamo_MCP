...
## 🚀 Major Updates: Auto-Start and Centralized Management
...
- **`domain/`**: **[SOP Knowledge Base]** Standard Operating Procedures and troubleshooting guides.
  ...
  - `node_creation_strategy.md`: **[NEW]** Dual-track node creation strategy complete technical guide (decision tree + practical examples)
  - `architecture_analysis.md`: **[NEW]** Architecture conflict diagnosis report and dual-track improvement plan
  - `visual_analysis_workflow.md`: Standard execution workflow for `/image` command
