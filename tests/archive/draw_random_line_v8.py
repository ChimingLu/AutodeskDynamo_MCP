    ...
    try:
        async with sse_client("http://127.0.0.1:8000/sse") as streams:
            async with ClientSession(streams[0], streams[1]) as session:
                ...
                print(f"Drawing random line v8 from ({x1}, {y1}, {z1}) to ({x2}, {y2}, {z2})...")
                
                code_content = f"p_start_8 = Point.ByCoordinates({x1}, {y1}, {z1});\np_end_8 = Point.ByCoordinates({x2}, {y2}, {z2});\nline_8 = Line.ByStartPointEndPoint(p_start_8, p_end_8);"
