    ...
    try:
        async with sse_client("http://127.0.0.1:8000/sse") as streams:
            async with ClientSession(streams[0], streams[1]) as session:
                ...
                print(f"Drawing third line from ({x1}, {y1}, {z1}) to ({x2}, {y2}, {z2})...")
                
                code_content = f"p5 = Point.ByCoordinates({x1}, {y1}, {z1});\np6 = Point.ByCoordinates({x2}, {y2}, {z2});\nl_rand_3 = Line.ByStartPointEndPoint(p5, p6);"
